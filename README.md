...
A plugin manager for MHFZ. Ships with [d3d8to9](https://github.com/crosire/d3d8to9), using a slightly modified version of [egui-d3d9](https://github.com/unknowntrojan/egui-d3d9).
...
If you'd like to use a different dinput8.dll (such as the one created by XInput Plus), use the download named bunny-manager-dsound-\*.\*.\*.zip instead of the primary one.
